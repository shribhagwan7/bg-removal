...
const BgSlider = () => {
  ...
  return (
    <div className='pb-10 md:py-20 mx-2'>
      {/* Title */}
      <h1 className="mb-12 sm:mb-20 text-center text-3xl md:text-lg:text-4xl mt-4 font-semibold bg-linear-to-r from-gray-900 to-gray-500 bg-clip-text text-transparent">Remove Background With High <br /> Quality and Accuracy</h1>
